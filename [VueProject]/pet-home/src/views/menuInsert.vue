                ...
                <div class="container">
                  <div class="col-12">	
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-cm-2" :key="i" v-for="(m,i) in productImage.filter(c=>c.type==4)">
                            ...
                            <input class="form-control" type="file" accept="image/png,image/jpeg" @change="uploadFile($event.target.files, 4)">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-cm-2" :key="i" v-for="(m,i) in productImage.filter(c=>c.type==5)">
                                    <div class="position-relative">
                                        <img :src="`/download/${productId}/${m.path}`" class="img-fluid" />
                                        <div class="position-absolute top-0 end-0" style="cursor:pointer;" @click="deleteImage(m.id)">X</div>	
                                    </div>	
                            ...
                            <input class="form-control" type="file" accept="image/png,image/jpeg" @change="uploadFile($event.target.files, 5)">
                            <div class="alert alert-secondary" role="alert">
                                <ul>
                                    <li>최대 5개 가능</li>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-cm-2" :key="i" v-for="(m,i) in productImage.filter(c=>c.type==6)">
                                    <div class="position-relative">
                            ...
                            <input class="form-control" type="file" accept="image/png,image/jpeg" @change="uploadFile($event.target.files, 6)">
                            <div class="alert alert-secondary" role="alert">
                                <ul>
                                    <li>파일 사이즈 : 5M 이하</li>
                                    <li>파일 확장자 : png, jpg만 가능</li>
...
// eslint-disable-next-line
    ...
    export default {
        ...
        this.$router.push({path:'/SalesList'}); 
          ...
          let productDetail2 = await this.$api('/api/m_productDetail2', { param: [this.productId] })
        ...
        async getProductImage () {
          this.productImage = await this.$api('/api/m_imageList', { param: [this.productId] })
