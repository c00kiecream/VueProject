<template>
  <div class="container mt-5 mb-5">
    ...
    <h4 align="center">이용약관</h4><br>

    <div class="textblock">
      <h6>제1조(목적)</h6>
      <p>
      이 약관은 숑블리(전자상거래 사업자)이 운영하는 숑블리 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br>
    ...
    <div class="textblock">
      <h6>제2조(정의)</h6>
      <p>
      ① “몰”이란 숑블리 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
    ...
    <div class="textblock">
      ...
      <p>
      ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 숑블리 사이버 몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br>
    ...
    <div class="textblock">
      ...
      ④  “몰”이 호스팅을 변경하여 이전 할 경우 1년 동안 로그인하지 않은 휴면회원을 포함한 모든 "이용자"의 정보를 호스팅사에서 제공받아 이전하는 호스팅사에 고객의 정보를 등록하고 "몰"의 서비스 연속성 관리를 위한 용도로 사용할 수 있습니다.<br>
      </p>
    </div>
    ...
    <div class="textblock">
      ...
      ④ 이용자가 재화 등을 제공받을 때 발송비를 부담한 경우에 “몰”은 청약철회 시 그 비용을누가 부담하는지를 이용자가 알기 쉽도록 명확하게 표시합니다.<br>
      </p>
    </div>
    ...
    <div class="textblock">
      ...
      ③ 이용자가 직접 작성 및 등록한 평가점수, 리뷰, 답글, 사진 등의 게시물(이용자 콘텐츠)에 대한 저작권 및 지적 재산권은 해당 이용자에게 있으며, 이용자는 “몰”에 해당 이용자 콘텐츠를 무상으로 이용할 수 있는 권리를 부여합니다. 이용자가 공개적으로 작성 및 공유한 콘텐츠(예: 상품 리뷰)의 경우 “몰”은 제품의 홍보를 위해 상점 내에 이용자의 콘텐츠를 재가공하여 영구적으로 인용할 수 있습니다.<br>
      </p>
    </div>
    ...
    <div class="textblock">
      <h6>제24조(적립금 제도)</h6>
      <p>
      ① “몰”은 “몰”의 정책에 따라 적립금, 쿠폰(이하 ‘적립금 등’이라 함)제도를 운영합니다.<br>
      ② “몰”은 재화 등의 구매, 이벤트 등 정책에 따라 회원에게 적립금 또는 쿠폰을 지급할 수 있습니다.<br>
      ③ “몰”은 구입한 재화 등의 주문취소, 반품의 경우 혹은 회원의 요청 등에 따라 환불 대금을 적립금으로 지급할 수 있습니다.<br>
      ④ 회원은 재화 등을 구매 시 단독으로 또는 다른 결제수단과 결합하여 ‘적립금 등’을 현금과 동일하게 사용할 수 있으나, “몰”이 사전에 사용이 불가능하다고 고지한 경우에는 이를 사용할 수 없습니다.<br>
      ⑤ 다음 각 호의 경우 ‘적립금 등’은 소멸됩니다.
      </p>
      <ol>
        <li>“몰”을 탈퇴한 경우</li>
        <li>“몰”의 정책에 따라 적립금 및 쿠폰의 사용가능 조건 및 소멸에 대한 기준이 도래한 경우</li>
      </ol>
      <p>
      ⑥ 회원은 ‘적립금 등’을 타인에게 매매 또는 양도할 수 없고, 이를 부정하게 취득한 경우 “몰”의 권한으로 ‘적립금 등’을 회수할 수 있습니다.<br>
      </p>
    </div>
    ...
    <div class="textblock">
      ...
      <p>부 칙(시행일) 이 약관은 2023년 2월 12일 부터 시행합니다.</p>
    </div>
